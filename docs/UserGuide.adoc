...
=== Adding a patient/doctor: `add`

Adds a patient/doctor to the address book +
...
* `add r/patient n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01 ic/S9123456F`
* `add r/Doctor n/Betsy Crowe p/81234123 t/friend e/betsycrowe@example.com a/Newgate Prison p/1234567 t/Chief
md/Neurology`
...
=== Listing all relevant personnels : `list`

Shows a list of all patients and doctors in the address book. +
Format: `list`

=== Editing a patient : `edit`

Edits an existing patient/doctor in the address book. +
...
Finds doctors/patients with the keyword specified by the user. Specified keyword can belong to any part of any attribute
 of the doctor/patient (i.e. name, phone number, address, tags etc).
 +

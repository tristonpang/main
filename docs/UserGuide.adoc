...
=== Schedule medical appointments : `schedule`
...
=== Viewing medical history of patients : `records`

Displays the most updated medical records of a given patient if no date is specified. Else, displays the last updated medical record before the specified date. +
...
Displays the first medical record of Jack before 22nd November 2018.
* `records n/Jack` +
Displays the medical records of Jack

=== Updating medical history of patients : `update`

Adds a new medical record for the patient as the most updated record using the current date as date of record. +
Format: `update n/name mr/new_updated_medical_records`

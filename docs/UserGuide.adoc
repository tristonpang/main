...
=== Scheduling medical appointments : `appointment`

Schedules a patient for a medical appointment at a specific date and time.
Format: `appointment n/NAME d/DATE t/START_TIME t/END_TIME rn/ROOM_NUMBER`
...
* `appointment n/Jack d/22.11.2018 t/1300 t/1400 rn/T24` +
...
* *Schedule Medical Appointments* : `appointment n/NAME d/DATE t/START_TIME t/END_TIME rn/ROOM_NUMBER` +
e.g. `appointment n/Jack d/22.11.2018 t/1300 t/1400 rn/T24`

...
*** Set up Travis and AppVeyor badge for tracking of project build https://github.com/CS2103-AY1819S1-W16-3/main/commit/e5ee2bc09478cd85f5d867e9c4b1f6fc1a5a710d[#49]
** Documentation:
*** Modified README, AboutUs and ContactUs to match project specifications and team information. https://github.com/CS2103-AY1819S1-W16-3/main/pull/36[#36]

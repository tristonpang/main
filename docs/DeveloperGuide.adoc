...
** Pros: Allows for a powerful and precise search function by providing the user the option to specify exactly which `Person` attributes are of interest.
...
** Pros: An extremely powerful search function that is both simple to use and accurate.
** Cons: It is incredibly difficult to implement such an algorithm without the use of machine-learning algorithms or an internet connection.
// end::findcommand[]

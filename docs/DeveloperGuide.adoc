...
[discrete]
=== Use case: Displays a specific doctor’s schedule

*MSS*

1.  User requests to view the schedule of a particular doctor.
2.  Addressbook displays schedule of the specified doctor (in ascending chronological order)
+
Use case ends

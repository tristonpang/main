...
|`*` |user |add a remark for a patient |record down anything that doesn't fall in given categories
...
3.  User requests to schedule a patient at a specific date and time
...
[discrete]
=== Use case: Undo and Redo commands (regardless of exiting the program)

*MSS*

1.  User requests to undo/redo the last command/change (to the AB data).
2.  Addressbook displays / informs user of that last change
3.  Addressbook undoes / redoes the last change
+
Use case ends
...
[none]
* 1a. There were no changes (to data) before or after current state.
[none]
** 1a1. Addressbook informs user that there are no changes to redo/undo.
+
Use case resumes at step 1
